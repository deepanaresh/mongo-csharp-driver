...
#pragma warning restore
        ...
        public void TestEquals()
        {
            ...
            clone = settings.Clone();
            clone.CredentialsList = new[] { MongoCredentials.CreateStrongestCredentials("db1", "user2", "password2") };
            Assert.IsFalse(clone.Equals(settings));
        ...
        public void TestFromClientSettings()
        {
            ...
            Assert.AreEqual(url.AuthenticationProtocol, settings.CredentialsList.Single().AuthenticationProtocol);
