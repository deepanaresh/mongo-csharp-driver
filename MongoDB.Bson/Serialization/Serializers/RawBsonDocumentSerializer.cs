...
{
    /// <summary>
    /// Represents a serializer for RawDocuments.
    /// </summary>
    public class RawBsonDocumentSerializer : BsonBaseSerializer
    {
            ...
            else
            {
                switch (bsonType)
                {
                    case BsonType.Document:
                        return bsonReader.ReadRawBsonDocument();
                    default:
            ...
            IBsonSerializationOptions options)
        {
            ...
            {
                var rawDocument = (RawBsonDocument)value;
                bsonWriter.WriteRawBsonDocument(rawDocument);
            }
        }
    }
}
